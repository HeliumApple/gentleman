...
export const Editor = {
    ...
    get hasConfig() { return !isNullOrUndefined(this.config.concepts); },
        /**
     * Verifies that the editor has an annotation model loaded
     * @returns {boolean} Value indicating whether the editor has a projection model loaded
     */
    //get hasAnnotationModel() {return !isNullOrUndefined(this.subEditor);},
    /**
    ...
    /*loadAnnotationModel($schema, values){
        this.subEditor.loadConceptModel($schema,values);
    },*/

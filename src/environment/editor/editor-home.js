...
export const EditorHome = {
    ...
    refresh() {
        const { hasConceptModel, hasProjectionModel,hasConfig } = this.editor;
...
function createMenu() {
    ...
    this.configFileIO = createFileIO.call(this, "config");
    ...
    let configMenu = createDiv({
        class: ["editor-home-section__menu", "editor-home-section__menu--annotation"],
    }, [this.configFileIO.render()]);

    content.append(modelMenu, projectionMenu,configMenu);

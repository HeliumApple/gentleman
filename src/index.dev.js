...
const style_tl = require(`@models/${Model.DD}-model/concept.json`);

/*const SANNOTATION__CONCEPT = require(`@models/${Model.MM}-model/concept.json`);
const SANNOTION__PROJECTION = require(`@models/${Model.MM}-model/projection.json`);
const SANNOTATION__EDITOR = require(`@models/${Model.MM}-model/config.json`);*/
...
editor.addConcept(style_tl);

//editor.addConcept(SANNOTATION__CONCEPT);
//editor.addProjection(SANNOTION__PROJECTION);
